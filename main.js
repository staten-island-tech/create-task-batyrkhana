...
function retrieveFeelingQuote(category) {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            const quoteObject = {author: result[0].author,quote: result[0].quote,category: category};
...
DOMSelectors.generalForm.addEventListener('submit', function quoteInitiate(userSubmit) {
    ...
    if (valueUserAge === 'young') {
        console.log("You still have a long life ahead of you) Look what is out there!");
    } else {
        console.log("Focus on furthering your friendships. Appreciate the small things in life.");
    }
    categorySet();
